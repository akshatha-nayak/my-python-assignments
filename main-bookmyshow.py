# Project Book My Show by Akshatha Nayak

x = 10
Booked_seat = 0
price_of_ticket = 0
Current_income = 0
price_of_front_ticket = 0
price_of_back_ticket = 0
Total_Income = 0
        ...
        if Row_number in range(1, Row+1) and Column_number in range(1, Seats+1):
            if table_of_chart[str(Row_number-1)][str(Column_number)] == 'S':
                ...
                if confirm == 'yes':
                    ...
                    Booked_seat += 1
                    Total_Income = Total_seat*price_of_ticket
                    Current_income += price_of_ticket
                else:
                    continue
